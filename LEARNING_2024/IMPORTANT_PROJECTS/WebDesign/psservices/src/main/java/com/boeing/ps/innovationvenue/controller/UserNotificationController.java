...
public class UserNotificationController {
	...
	@ResponseBody
	public List<NotificationVO> getFirst10UserNotificationMessage(@RequestParam String bemsID,
	...
	@ResponseBody
	public ResponseEntity<?> getUserNotificationUnReadCount(@RequestParam String bemsID, @RequestParam String isPublic) {
